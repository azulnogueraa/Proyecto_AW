...
![Pantalla de Detalle de Cursos](ss/contenido.png){width=70%}
...
---------------`TERMINAR CUANDO ARREGLEN PANTALLAS MIS CURSOS Y MIS ALUMNOS`----------------------------------------------
...
![Pantalla de Detalle de Cursos](ss/admin.png){width=70%}
