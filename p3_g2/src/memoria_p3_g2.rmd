...
- box_curso.php : Estructura de los box de cursos.
...
URL al servicio de phpmyadmin: 

[https://phpmyadmin.containers.fdi.ucm.es/index.php?route=/&route=%2F&server=13](https://phpmyadmin.containers.fdi.ucm.es/index.php?route=/&route=%2F&server=13)

- Usuario: root

- Contraseña: UEp7y90WZsGqKUtAG_J8

- Identificador del VPS asociado: vm013
