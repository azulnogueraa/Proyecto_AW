        ...
        if ($curso) {
            ...
            <div id="contenedor_editar_curso">
                ...
                <form action="actualizar_curso.php" method="POST">
                    ...
                    <input type="text" id="nombre_curso" name="nombre_curso" value="{$curso['nombre_curso']}" required><br><br>
                    ...
                    <input type="text" id="nivel_dificultad" name="nivel_dificultad" value="{$curso['nivel_dificultad']}" required><br><br>
